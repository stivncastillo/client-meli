  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="twitter:title" content={`Mercado Libre | ${item?.title}`} />
        <meta name="twitter:creator" content="@Mercadolibre" />
        <meta name="twitter:description" content={item?.title} />
        {item?.picture && <meta name="twitter:image" content={item?.picture} />}

        {/* Facebook */}
        <meta property="og:title" content={`Mercado Libre | ${item?.title}`} />
        <meta property="og:description" content={item?.title} />
        {item?.picture && <meta name="og:image" content={item?.picture} />}
